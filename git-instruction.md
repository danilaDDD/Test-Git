...
git clone <HTTPS> - клонирует репозиторий из удаленного в локальный

git push - загрузить обновление на удаленный репозиторий с локального

git pull - обновить локальный репозиторий из удаленного

git push -u origin <mainBrnch> - устанавливает связь между локальной веткой и удаленной