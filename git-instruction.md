...
git rebase <target commit> - переносит текущий коммит на вершину указанного коммита

git reset HEAD~1- переносит текущий коммит на предыдущий в локальном репозитории

git revert HEAD~1 - создает новый коммит, аналогичный прерыдущиму для имитации возврата к предыдущему коммиту для внесения изменений в удаленном репозитории
