...
**_Локальный (удалённые) репозитории_** — это всего-навсего копии вашего репозитория, хранящиеся на другом компьютере.

## Основные команды

+ *git clone*  - это команда, которая создаст локальную копию удалённого репозитория
...
+ *git pull* - выполняет фунцию 2-ух команд '_git fetch_' и '_git merge_'
+ *git push* - отвечает за загрузку локальных изменений в указанный удалённый репозиторий, а также включение локальных коммитов в состав удалённого репозитория