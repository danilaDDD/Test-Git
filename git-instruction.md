...
● Делаем clone СВОЕЙ версии репозитория  или 
...
git clon "имя адреса репозитория" - скачиваем удалённый репозиторий на свой ПК

git pull - скачиваем актуальное состояние репозитория с удалённого аккаунта  с одновременным слиянием 

git push - отправляет все изменения с нашего репозитория на внешний репозиторий 
