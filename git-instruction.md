...
Добавляем команды для работы с удаленным репозиторием:
...
Чтобы автоматически получить изменения из удалённой ветки и слить их со своей текущей вы можете использовать команду git pull  (с настроенного репозитория)
