...
## Команды по работе с удаленным репозиторием (GitHub)

1. **Git pull** - команда, позволяющая скачать все из текущего репозитория и автоматически сделать merge  с нашей версией
2. **Git push** - команда, позволяющая отправить нашу версию репозитория на внешний репозиторий
3. **Git request** - команда для предложения изменений (запрос на вливание изменений в репозиторий) 
4. **fork** - ответвление репозитория (скопировать репозиторий к себе)
