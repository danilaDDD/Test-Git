Извени я сделал форк твоего репозитория который был в Github открыл его у себя как локальный репозиторий и добавил этот текст. Я сделаю тебе запрос на изменения , это нужно для выполнения Д/З. )
