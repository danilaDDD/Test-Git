...
git pull - получение изменений и слияние с локальной версией (подтягивание изменения с github в локальный репозеторий). Работает как git merge
git push - отправляет локальную версию репозитория на внешний (подтягивает изменения из локального репозитария на github)
